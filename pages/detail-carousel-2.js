...
class DetailCarousel2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
				...
				<div class="row">
					<div class="col-lg-8">
						<div id="carousel_in" class="owl-carousel owl-theme add_bottom_30">
					      <div class="item"><img src="/images/carousel_detail_1.jpg" alt=""/></div>
					      <div class="item"><img src="/images/carousel_detail_2.jpg" alt=""/></div>
					      <div class="item"><img src="/images/carousel_detail_3.jpg" alt=""/></div>
					      <div class="item"><img src="/images/carousel_detail_4.jpg" alt=""/></div>
					    </div>
						<section id="description">
							...
							<div class="room_type first">
								<div class="row">
									<div class="col-md-4">
										<img src="/images/gallery/hotel_list_1.jpg" class="img-fluid" alt=""/>
									</div>
									<div class="col-md-8">
										<h4>Single Room</h4>
							...
							<div class="room_type alternate">
								<div class="row">
									<div class="col-md-4">
										<img src="/images/gallery/hotel_list_2.jpg" class="img-fluid" alt=""/>
									</div>
									<div class="col-md-8">
										<h4>Double Room</h4>
										<p>Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam vulputate pertinacia eum at.</p>
							...
							<div class="room_type last">
								<div class="row">
									<div class="col-md-4">
										<img src="/images/gallery/hotel_list_3.jpg" class="img-fluid" alt=""/>
									</div>
									<div class="col-md-8">
										<h4>Suite Room</h4>
										<p>Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam vulputate pertinacia eum at.</p>
...
export default DetailCarousel2;
