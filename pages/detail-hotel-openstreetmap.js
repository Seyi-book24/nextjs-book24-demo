...
class DetailHotelOpenStreetMap extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
  ...
  render() {
				...
				<div class="row">
					...
					<aside class="col-lg-4" id="sidebar">
						...
						<ul class="share-buttons">
							...
							<li><a class="gplus-share" href="#0">
                            <i class="social_googleplus"></i> Share</a></li>
						</ul>
					</aside>
				</div>
				{/* <!-- /row --> */}
    ...
    <script src="js/leaflet_map/leaflet_single_func.js"></script>
...
export default DetailHotelOpenStreetMap;
